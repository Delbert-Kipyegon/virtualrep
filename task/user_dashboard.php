            ...
            <div class="space-y-4 py-16">
                <?php if (empty($tasks)): ?>
                    <div class="flex flex-col items-center justify-center text-gray-500 py-10">
                        <img class="w-60 h-60 rounded-full shadow-md mb-4 transition-transform duration-300 ease-in-out hover:scale-105"
                            src="../Images/notasks.jpg" alt="no-tasks-img" />
                        <p class="text-sm mt-2 font-light">No Tasks Available</p>
                    </div>
